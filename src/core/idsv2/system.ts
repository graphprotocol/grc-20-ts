...
export const CURRENCY_ATTRIBUTE = Id('9291e563-afbe-4709-8780-a52cbb0f4aa9');
export const CURRENCY_SIGN_ATTRIBUTE = Id('d9ada086-52e3-4b66-8893-0ccf2f9fd9ea');
export const CURRENCY_SYMBOL_ATTRIBUTE = Id('ace1e96c-9b83-47b4-bd33-1d302ec0a0f5');
export const CURRENCY_USD_ATTRIBUTE = Id('0d4d1b02-a9e8-4982-92c4-99b1d22cd430');
export const CURRENCY_GBP_ATTRIBUTE = Id('95593310-1e7c-43da-a02c-a6f4b630d48a');
export const CURRENCY_EUR_ATTRIBUTE = Id('6d5a3fed-379c-4889-b60e-d6265a482c93');
